...
// Function to receive a line ending with '\n'
...
// Function to send all bytes reliably
...
int main()
{
    ...
    std::cout << line << std::endl; // WELCOME
    ...
    while (true)
    {
        ...
        else if (cmd.rfind("UPLOAD ", 0) == 0)
        {
            ...
            // ===== FIXED LINE =====
            // Previously: std::ifstream ifs("client/" + fname, std::ios::binary);
            // Now it uses the exact file path provided
            ...
            if (recv_line(sock, line) <= 0)
                break;
            std::cout << line << std::endl; // UPLOAD_OK or error
        }
        else if (cmd == "EXIT")
        {
            break;
...
//         {
//             std::string fname = cmd.substr(7);
//             std::string local = fname; // relative path in client/
//             std::ifstream ifs(local, std::ios::binary);
//             if (!ifs)
//             {
//                 std::cout << "Local file not found: " << local << std::endl;
//                 continue;
//             }
//             ifs.seekg(0, std::ios::end);
//             size_t size = ifs.tellg();
